...
public class main {
	...
	public static void main(String[] args) {
		...
		while (prog!=1) {
			...
			System.out.println("\n1 - Quitter le programmme"
				...
				+ "\n3 - Afficher les documents par cat�gorie, sujet, tag"
				+ "\n4 - Afficher le sujet le plus fr�quent"
	...
	static void newDoc(int docID, int storageAddress) {
		...
		showTopics();
		System.out.println("Quel est le th�me (donnez le num�ro) : ");	
		topic = s3.nextInt();
		...
		showTags();
		System.out.println("Quelle balise voulez vous attribuer (donnez le num�ro) : ");	
		tag = s4.nextInt();
		...
		showCategories();
		System.out.println("Dans quelle cat�gorie souhaitez vous ranger le fichier (donnez le num�ro) : ");	
		category = s5.nextInt();
	...
	static void registerDoc(Document Doc, int topic, int category) {
		try
        {
            ...
            Connection con=DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/tp4","root","Thioro78@");
            String query = " insert into project.document (DocumentID, DocumentName, DocumentDate, StorageAddress, TopicID, CategoryID)"
                    + " values (?, ?, ?, ?, ?, ?)";
	...
	static void showMostFreqTopic() {
		try
        {
            ...
            while (rs.next())
            {
              String Topic = rs.getString("Topic");
              // print the results
              System.out.println("Th�me le plus fr�quent : " + Topic);
            }
            stmt.close();
        }
        catch(Exception e)
	...
	static void modifyDate() {
		...
		System.out.println("Quel document souhaitez-vous modifier ? (donnez le num�ro) : ");	
		docID = s14.nextInt();
	...
	static void addTag() {
		...
		System.out.println("Quelle balise voulez-vous ajouter ? (donnez le num�ro) : ");	
		tagID = s17.nextInt();
